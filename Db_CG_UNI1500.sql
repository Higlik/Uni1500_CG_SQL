...
Create Table Tb_Cliente (CPF INT PRIMARY KEY, NOME VARCHAR (255), Telefone INT, FK_Pais INT FOREIGN KEY REFERENCES Tb_Pais(Id), FK_Empresa INT FOREIGN KEY REFERENCES Tb_Empresa(Id))
Create Table Tb_Funcionario (Matricula INT PRIMARY KEY, Nome VARCHAR (255), CPF INT)
